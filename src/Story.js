...
class Story extends Component {
    ...
    sendVote(vote){
      ...
      request.post(window.baseApiUrl + '/stories/' + storyId + "/votes")
    ...
    fetchNumberOfVotes(){
     ...
     let storyId = this.props.story._id
     request
      .get(window.baseApiUrl + '/stories/' + storyId + "/votes")
      .end(function(err, res){
    ...
    render() {
      return (
        <div className='individual-story'>
          ...
          <li><a href={window.baseApiUrl + '/stories/' + this.props.story._id + '/votes'}>Votes: {this.state.voteCount}</a></li>
